...
When the hook mechanics feel comfortable, continue with [Build the Full Project Setup](/tutorials/project-setup).

If you want a stricter Codex-style RED/GREEN/STOP guard stack translated into Claude Code, follow [Build an Advanced Hook Stack](/tutorials/advanced-hooks) next.
